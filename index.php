...
<html>
	...
	<body>
                ...
                <a class = "menu" id = "menuHaut" href = "menu.php"><img id = "logoMenu" src = "Images/menu.png"/></a>
                    <?php    
                        if(!empty($_SESSION['identifiant'])) {
                            ...
                            echo "<nav id = 'navBoutonCommander'>
                                    <a id = 'boutonCommander' href = 'pageSeConnecter.php' title = 'Connectez-vous pour commander'><h2 id = 'lettreCommander'>Commander</h2></a>
                                </nav>";  
                        }
                        if(!empty($_SESSION['identifiant'])) {
        ...
        <div id = "barreBas">
            <div id = "maps">
                <a href = "https://www.bing.com/maps?q=lycee+paul+eluard&qs=n&form=QBRE&sp=-1&ghc=1&lq=0&pq=lycee+paul+eluar&sc=10-16&sk=&cvid=936866CF7EB143D18CB72B13A6394633&ghsh=0&ghacc=0&ghpl="><h2 id = "aller" >S'Y RENDRE</h2></a>
        ...
        <footer>
            <a href = "menu.php">Mentions légales</a>
