	...
	<body>
        ...
        <div id = "principal">
            ...
            <section id = "sectionRose">
                <nav id = "navConnexion">
                    <a id = "boutonCreerCompte" href = "pageSeConnecter.php"><h2 id = "lettreLogin">Se connecter</h2></a>
                </nav> 
                <nav id = "navConnexion">
                    <a id = "boutonSeConnecter" href = "pageCreerCompte.php"><h2 id = "lettreLogin">Créer compte</h2></a>
                </nav>        
            </section>
