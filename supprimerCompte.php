...
<html>
	<head>
		<meta charset = "utf-8"/>
		<title>CHEZ PE</title>
		<link rel = "stylesheet" href = "styleSupprimerCompte.css"/>
	</head>
	...
	<body>
        ...
        <div id = "principal">
            ...
            <section id = "sectionRose">
                <h2 id = "questionSupprimer">Voulez-vous suppimer votre compte définitivement ?<br></h2>
                <nav id = "navConnexion">
                    <a id = "boutonOui" href = "ouiSupprime.php"><h2 id = "lettreLogin">Oui</h2></a>
                </nav> 
                <nav id = "navConnexion">
                    <a id = "boutonNon" href = "profil.php"><h2 id = "lettreLogin">Non</h2></a>
                </nav>     
            </section>
