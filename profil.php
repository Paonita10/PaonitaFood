	...
	<body>
        ...
        <div id = "principal">
            ...
            <section id = "sectionRose">
                <nav id = "navConnexion">
                    <a id = "boutonModif" href = "modifCompte.php"><h2 id = "lettreLogin">Modifier compte</h2></a>
                </nav> 
                <nav id = "navConnexion">
                    <a id = "boutonSuppr" href = "supprimerCompte.php"><h2 id = "lettreLogin">Supprimer compte</h2></a>
                </nav> 
                <nav id = "navConnexion">
                    <a id = "boutonDeco" href = "deconnexion.php"><h2 id = "lettreLogin">Se déconnecter</h2></a>
                </nav>       
            </section>
